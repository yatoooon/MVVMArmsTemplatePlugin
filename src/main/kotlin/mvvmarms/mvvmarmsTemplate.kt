...
import com.android.tools.idea.gradle.structure.configurables.ui.modules.MODULE_PLACE_NAME
 ...
 * @CreateDate:     2021/4/1
 * @Author:         Creator
 * @Description:    mvvmarms模板配置
 */
val mvvmarmsTemplate
    get() = template {
        name = "mvvmarmsTemplate"
        description = "一键创建 mvvmarms 单个页面所需要的全部组件"
        ...
        val moduleName = stringParameter {
            ...
            help = "请填写你的Module,请认真核实此包名是否是正确的Module名"
            suggest = {
                packageName.value.split(".").let {
                    if (it.isNotEmpty() && it.size > 1) {
                        it[it.size - 1].toLowerCase()
                    } else {
                        ""
                    }
                }
        ...
        val activityLayoutName = stringParameter {
            ...
            suggest = {
                ...
                } + "_" + "activity_" + pageName.value.toLowerCase()
            }
        ...
        val activityPackageName = stringParameter {
            ...
            constraints = listOf(Constraint.PACKAGE)
            suggest = { "${packageName.value}.mvvm.activity" }
        }
        ...
        val fragmentLayoutName = stringParameter {
            ...
            suggest = {
                ...
                } + "_" + "fragment_" + pageName.value.toLowerCase()
            }
        }
        ...
        val fragmentPackageName = stringParameter {
            ...
            suggest = { "${packageName.value}.mvvm.fragment" }
        }
        ...
        val modelPackageName = stringParameter {
            ...
            suggest = { "${packageName.value}.mvvm.model" }
        }
        ...
        val viewModelPackageName = stringParameter {
            ...
            suggest = { "${packageName.value}.mvvm.vm" }
        }
